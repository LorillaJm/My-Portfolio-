...
const AdminLogin = () => {
  ...
  useEffect(() => {
    if (currentUser && isAdmin && !showSuccess) {
      setShowSuccess(true);
  ...
  }, [currentUser, isAdmin, navigate, showSuccess]);
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Navigation for admin is handled by the useEffect
    } catch (error) {
  ...
  if (showSuccess) {
    return <SuccessAnimation message="Admin Login Successful!" />;
  }
